...
import 'package:fooderfetch/models/profile_manager.dart';
...
class ProfileScreen extends StatefulWidget {
  static MaterialPage page(User user) {
    return MaterialPage(
        name: FooderFetchPages.profilePath,
        key: ValueKey(FooderFetchPages.profilePath),
  ...
  Widget buildMenu() {
    return ListView(
      children: [
        buildDarkModeRow(),
        ListTile(
          title: const Text('View yeditepe.edu.tr'),
          onTap: () async {
            if (kIsWeb) {
              await launch('https://www.yeditepe.edu.tr/');
            } else {
              Provider.of<ProfileManager>(context, listen: false)
                  .tapOnYeditepe(true);
            }
